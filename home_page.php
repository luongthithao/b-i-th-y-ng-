...
<body>
    <div class="container my-5">
        ...
        <a class="btn btn-primary mb-4" href="/PHP/add_page.php" role="button">Add Students</a>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-primary btn-sm" href="/PHP/update_page.php?id=<?php echo $row['id']; ?>">Update</a>
                                <a class="btn btn-primary btn-sm" href="/PHP/delete_page.php?id=<?php echo $row['id']; ?>">Delete</a>
                            </td>
                        </tr>
                        <?php
                    }
